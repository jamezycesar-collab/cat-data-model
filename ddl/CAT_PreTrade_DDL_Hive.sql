-- ==========================================================================
-- CAT-PreTrade Enterprise Trade Lifecycle - CONSOLIDATED Hive 3.x DDL
-- Auto-concatenated by. Run sequentially in a Hive metastore.
-- ==========================================================================

-- @@@ Begin: 01_party_model_hive.sql
-- ========================================================================
-- Hive 3.x variant of 01_party_model_delta.sql
...
CREATE TABLE IF NOT EXISTS party (
 ...
 _created_at TIMESTAMP COMMENT 'CDF audit: record creation timestamp',
 _updated_at TIMESTAMP COMMENT 'CDF audit: record update timestamp'
)
STORED AS PARQUET
...
CREATE TABLE IF NOT EXISTS party_identifier (
 ...
 is_primary BOOLEAN COMMENT 'Primary identifier flag for this id_type within the party (exactly one TRUE per party+id_type)',
 effective_date DATE NOT NULL COMMENT 'SCD2 effective date',
 end_date DATE NOT NULL DEFAULT DATE'9999-12-31' COMMENT 'SCD2 end date',
 _created_at TIMESTAMP COMMENT 'CDF audit',
 _updated_at TIMESTAMP COMMENT 'CDF audit'
...
TBLPROPERTIES (
 ...
 'description' = 'Address dimension (PII-sensitive
) with purpose tagging',
...
CREATE TABLE IF NOT EXISTS account (
 ...
 margin_eligible_flag BOOLEAN COMMENT 'Whether account can trade on margin (renamed from margin_eligible boolean convention)',
 ...
 options_level INT COMMENT 'Options approval: 0=none, 1=covered calls, 2=spreads, 3=puts, 4=uncovered writes, 5=complex spreads',
...
TBLPROPERTIES (
 ...
 'description' = 'Account dimension (customer, proprietary, firm
) with margin regime and custodian linkage',
 'compression.codec' = 'zstd',
 'subject_area' = 'party',
 'source_lineage' = 'pre-trade'
);
...
CREATE TABLE IF NOT EXISTS party_contact (
 ...
 is_primary BOOLEAN COMMENT 'Primary contact flag for this contact_type within the party',
...
CREATE TABLE IF NOT EXISTS beneficial_ownership (
 ...
 control_flag BOOLEAN NOT NULL COMMENT 'TRUE if owner has de-facto control irrespective of percentage (board/voting/contractual)',
 ...
 ultimate_beneficial_owner_flag BOOLEAN NOT NULL COMMENT 'TRUE when this row represents the terminal UBO (owner has no further owners); resolved by section 1A recursive CTE',
...
-- ============================================================================
-- @@@ End: 01_party_model_hive.sql

-- @@@ Begin: 02_instrument_model_hive.sql
-- ========================================================================
...
-- ============================================================================
-- @@@ End: 02_instrument_model_hive.sql

-- @@@ Begin: 03_venue_model_hive.sql
-- ========================================================================
...
-- END OF FILE - 4 CREATE TABLE statements
-- ============================================================================
-- @@@ End: 03_venue_model_hive.sql

-- @@@ Begin: 04_agreement_model_hive.sql
-- ========================================================================
-- Hive 3.x variant of 04_agreement_model_delta.sql
-- Auto-generated by _delta_to_hive.py - do NOT hand-edit.
-- Changes from Delta:
-- USING DELTA -> STORED AS PARQUET
-- GENERATED ALWAYS AS (current_timestamp) removed (populate via ETL)
...
CREATE TABLE IF NOT EXISTS agreement (
 ...
 amendment_count INT NOT NULL COMMENT 'Number of amendments executed',
 last_amendment_date DATE COMMENT 'Date of most recent amendment',

 -- Cross-default and termination
 cross_default_flag BOOLEAN NOT NULL COMMENT 'TRUE if cross-default clause applies across agreements with this counterparty',
 cross_default_threshold DECIMAL(18,2) COMMENT 'Threshold amount for cross-default trigger',
 automatic_early_termination BOOLEAN NOT NULL COMMENT 'TRUE if AET clause is elected (common in ISDA)',

 -- Netting
 close_out_netting_flag BOOLEAN NOT NULL COMMENT 'TRUE if close-out netting applies (standard in ISDA/GMRA/GMSLA)',
 payment_netting_flag BOOLEAN NOT NULL COMMENT 'TRUE if payment netting is elected',
...
CREATE TABLE IF NOT EXISTS collateral_agreement (
 ...
 rehypothecation_flag BOOLEAN NOT NULL COMMENT 'TRUE if receiving party can re-use pledged collateral (common in PB, not in bilateral CSA)',

 -- Substitution
 substitution_rights STRING NOT NULL DEFAULT 'NONE' COMMENT 'NONE, WITH_CONSENT, WITHOUT_CONSENT',

 -- Regulatory
 regulatory_im_flag BOOLEAN NOT NULL COMMENT 'TRUE if subject to UMR (Uncleared Margin Rules) / BCBS-IOSCO Phase 6',
...
CREATE TABLE IF NOT EXISTS margin_call (
 ...
 -- Dispute
 dispute_flag BOOLEAN NOT NULL COMMENT 'TRUE if call was disputed',
...
CREATE TABLE IF NOT EXISTS repo_transaction (
 ...
 -- Substitution
 substitution_allowed BOOLEAN NOT NULL COMMENT 'TRUE if seller can substitute collateral securities',
...
CREATE TABLE IF NOT EXISTS securities_loan (
 ...
 manufactured_payment_flag BOOLEAN NOT NULL COMMENT 'TRUE if dividends/coupons on loaned securities are owed as manufactured payments from borrower to lender',

 -- Voting
 voting_rights_retained BOOLEAN NOT NULL COMMENT 'TRUE if lender retains voting rights (requires recall before record date)',
 ...
 buy_in_flag BOOLEAN NOT NULL COMMENT 'TRUE if buy-in was executed due to borrower failure to return',
...
CREATE TABLE IF NOT EXISTS commission_schedule (
 ...
 soft_dollar_flag BOOLEAN NOT NULL COMMENT 'TRUE if part of a commission sharing arrangement',
...
-- ============================================================================
-- @@@ End: 04_agreement_model_hive.sql

-- @@@ Begin: 05_pretrade_model_hive.sql
-- ========================================================================
...
-- END OF FILE - 5 CREATE TABLE statements
-- ============================================================================
-- @@@ End: 05_pretrade_model_hive.sql

-- @@@ Begin: 06_order_request_model_hive.sql
-- ========================================================================
...
-- ============================================================================
-- @@@ End: 06_order_request_model_hive.sql

-- @@@ Begin: 07_order_stage_model_hive.sql
-- ========================================================================
...
-- END OF FILE - 4 CREATE TABLE statements
-- ============================================================================
-- @@@ End: 07_order_stage_model_hive.sql

-- @@@ Begin: 08_execution_model_hive.sql
-- ========================================================================
-- Hive 3.x variant of 08_execution_model_delta.sql
-- Auto-generated by _delta_to_hive.py - do NOT hand-edit.
-- Changes from Delta:
-- USING DELTA -> STORED AS PARQUET
-- GENERATED ALWAYS AS (current_timestamp) removed (populate via ETL)
...
CREATE TABLE IF NOT EXISTS execution (
 ...
 manual_flag BOOLEAN NOT NULL COMMENT 'TRUE for MOOT manual fills',
 affiliate_flag BOOLEAN COMMENT 'CAT affiliateFlag',
 cancel_flag BOOLEAN NOT NULL COMMENT 'TRUE if this fill was cancelled (BUST)',
...
-- ============================================================================
-- @@@ End: 08_execution_model_hive.sql

-- @@@ Begin: 09_allocation_model_hive.sql
-- ========================================================================
-- Hive 3.x variant of 09_allocation_model_delta.sql
-- Auto-generated by _delta_to_hive.py - do NOT hand-edit.
-- Changes from Delta:
-- USING DELTA -> STORED AS PARQUET
-- GENERATED ALWAYS AS (current_timestamp) removed (populate via ETL)
...
CREATE TABLE IF NOT EXISTS allocation (
 ...
 manual_flag BOOLEAN NOT NULL COMMENT 'TRUE for MOFA manual allocations',
...
-- END OF FILE - 2 CREATE TABLE statements
-- ============================================================================
-- @@@ End: 09_allocation_model_hive.sql

-- @@@ Begin: 10_posttrade_model_hive.sql
-- ========================================================================
...
-- END OF FILE - 4 CREATE TABLE statements
-- ============================================================================
-- @@@ End: 10_posttrade_model_hive.sql

-- @@@ Begin: 11_position_model_hive.sql
-- ========================================================================
-- Hive 3.x variant of 11_position_model_delta.sql
-- Auto-generated by _delta_to_hive.py - do NOT hand-edit.
-- Changes from Delta:
-- USING DELTA -> STORED AS PARQUET
-- GENERATED ALWAYS AS (current_timestamp) removed (populate via ETL)
...
CREATE TABLE IF NOT EXISTS position (
 ...
 quantity_long DECIMAL(18,4) NOT NULL COMMENT 'Long quantity (positive)',
 quantity_short DECIMAL(18,4) NOT NULL COMMENT 'Short quantity (positive magnitude of short)',
...
-- END OF FILE - 2 CREATE TABLE statements
-- ============================================================================
-- @@@ End: 11_position_model_hive.sql

-- @@@ Begin: 12_operations_regulatory_model_hive.sql
-- ========================================================================
...
-- ============================================================================
-- @@@ End: 12_operations_regulatory_model_hive.sql

-- @@@ Begin: 13_reference_tables_hive.sql
-- ========================================================================
...
-- ============================================================================
-- @@@ End: 13_reference_tables_hive.sql
